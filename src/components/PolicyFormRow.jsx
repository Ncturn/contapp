...
const PolicyFormRow = ({ fieldName, index, register, errors, handleKeyDown }) => {
  ...
  return (
    <div className='policyRows' name={fieldName}>
      ...
      <div>
        <input onKeyDown={handleKeyDown} className='policyInput' ref={register({ required: 'Este campo es requirido', maxLength: { value: 8, message: 'La cuenta no debe ser mayor a 8 caracteres' } })} name={`${fieldName}.account`} placeholder='Agrega un identificador de cuenta' type='text' maxLength='8' />
